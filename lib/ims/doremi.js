...
//       Add xml to js-object conversion
//       Update to convert to jsObject (and not use raw xml)
//			- GetProductInformation *done*

import { soapBody as soapGen } from "./soap.js";
...
//const soapBody = require('./soapGen');
	...
	GetProductInformation() {									
		return new Promise(async (resolve, reject) => {
			...
			if (response == undefined){
				...
				try { 
					const body = convert.xml2js(response, {compact: false, spaces: 4});
					let soapBody = body.elements[0].elements[1].elements[0].elements[0];

					let server = {
						dataType: 'productInformation',
						productName: soapBody.elements[0].elements[0].text,
